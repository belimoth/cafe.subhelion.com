...
class Freezer(object):
	...
	def freeze_yield(self):
		...
		if remove_extra:
			...
			previous_files = set(
				# See http://github.com/SimonSapin/Frozen-Flask/issues/5
	...
	def _build_one(self, url, last_modified=None):
		...
		if os.path.splitext( filename )[1] not in [ ".css", ".html" ]:
			filename += ".html"
	...
	def _static_rules_endpoints(self):
		...
		for rule in self.app.url_map.iter_rules():
			...
			# http://github.com/pallets/flask/discussions/4136 for some
			# related discussion.
